...
if (isset($_GET['borrar'])) {
    ...
    $sql_delete = "DELETE FROM PLAYERS WHERE ID = $id_para_borrar";
...
<head>
    <meta charset="UTF-8">
    <title>System Database - PLAYERS</title>
...
<body class="bg-black text-gray-200 p-6 min-h-screen flex flex-col items-center">
    ...
    <div class="container max-w-6xl mx-auto">
        ...
        <h1 class="text-6xl text-center mb-10 uppercase texto-neon font-bold tracking-widest">
            GESTIONAR <span class="text-white">PLAYERS</span>
        </h1>
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="players_insert.php" class="boton-arcade border-green-500 text-green-500 px-6 py-2 hover:bg-green-500 font-bold text-xl">
                ✚ NUEVO JUGADOR
            </a>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <thead>
                    <tr class="bg-cyan-900/30 text-white text-4xl border-b-2 border-cyan-500">
                        ...
                        <th class="p-4 uppercase tracking-widest font-bold">ALIAS</th>
                        <th class="p-4 uppercase tracking-widest font-bold">NOMBRE REAL</th>
                        <th class="p-4 uppercase tracking-widest font-bold text-amber-400">NIVEL</th>
                ...
                <tbody class="text-xl">
                    <?php
                    // si no hay jugadores, muestro este mensaje
                    if (mysqli_num_rows($result) == 0) {
                        echo "<tr><td colspan='5' class='p-6 text-center text-gray-500 tracking-widest'>NO HAY NINGUN JUGADOR...</td></tr>";
                    }
                    ...
                    foreach ($result as $fila) {
                        ...
                        echo "<td class='p-4 text-white font-bold tracking-wide'>" . $fila['ALIAS'] . "</td>";
                        echo "<td class='p-4 text-cyan-100 uppercase'>" . $fila['NOMBRE'] . "</td>";
                        echo "<td class='p-4 text-amber-400 font-bold'>LVL " . $fila['NIVEL'] . "</td>";
                        echo "<td class='p-4 text-right space-x-4'>
                                
                                <a href='players_edit.php?id=" . $fila['ID'] . "' 
                                ...
                                <a href='players_list_and_delete.php?borrar=" . $fila['ID'] . "' 
                                    ...
                                    onclick=\"return confirm('¡CUIDADO!: ¿Quieres eliminar al jugador " . $fila['ALIAS'] . "?');\">
                                    BORRAR
                                </a>
                              </td>";
                        echo "</tr>";
